...
if dynamicBrowsers == "Chrome":
    ...
    time.sleep(2)
    driver.find_element_by_xpath("//li[2]//div[4]//a[1]").click() # click on Remove link for garlic item
    
    #here need to develop whether text message "" is availble in page and oranges , garlic text is not present then pass else fail.    
